export default {
  ...
  version: {
    ...
    forkUpdateAvailable: 'Fork release update available',
    upstreamUpdateAvailable: 'Upstream has a new release',
    upstreamUpdateHint: 'Merge upstream and publish a fork release first; do not install the upstream binary directly',
