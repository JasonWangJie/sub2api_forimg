export default {
  ...
  keys: {
    ...
    geminiImageGroupLabel: 'Gemini image group',
    openaiImageGroupLabel: 'OpenAI image group',
    selectImageGroupOptional: 'Optional for async dual-platform use',
    imagePlatformGroupsHint: 'Bind separate Gemini / OpenAI async image billing groups on one key. Empty falls back to the primary group.',
    statusLabel: 'Status',
