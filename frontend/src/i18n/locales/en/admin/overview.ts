export default {
    ...
    backup: {
      ...
      imageStorage: {
        ...
        providers: {
          ...
          custom_s3: 'Custom S3-compatible storage'
        },
        ...
        local: {
          ...
          publicBaseUrlPlaceholder: 'e.g. https://apiimg.example.com (your site host reverse-proxied to this service)',
          sitePublicBaseUrlHint: 'Signed /v1/images/local/...?exp=&sig= links use this host. Keep it identical to your site. Also set the async runtime public base URL below to the same value, then save. Use local_url only for a dedicated static host whose document root is data_dir.',
        ...
        maxInputGiBPerKey: 'Active SC inputs per API key (GiB)',
        taskRetentionDays: 'Task record retention (days)',
        resultRetentionDays: 'Result object retention (days)',
        advancedRuntime: 'Advanced worker and download limits',
        workerLeaseSeconds: 'Worker lease (seconds)',
        recoveryIntervalSeconds: 'Recovery scan interval (seconds)',
        retryBackoffSeconds: 'Storage/billing retry backoff (seconds)',
        ...
        referenceTransportLocalInlineData: 'Download locally as inlineData',
        referenceTransportFallbackInlineData: 'Pass through, then fall back to inlineData',
        openaiReferenceTransportHint: 'Hybrid mode switches only after an explicit fetch failure or multipart requirement, and persists the local stage.',
        geminiReferenceTransportHint: 'Hybrid mode switches only after an explicit URL fetch failure; ordinary 5xx responses keep the current transport.',
        referenceRetryTitle: 'Reference fetch retries',
        upstreamRetryTitle: 'Upstream transient retries',
        capacityRetryTitle: 'Account and model capacity retries',
        retryMaxAttempts: 'Extra retries',
        retryBaseSeconds: 'Base backoff (seconds)',
        retryMaxSeconds: 'Maximum backoff (seconds)',
        totalMaxRetries: 'Total retries per task',
        retryJitterPercent: 'Backoff jitter (%)',
        retryAfterMaxSeconds: 'Retry-After cap (seconds)',
        storageRetryAttempts: 'Storage retry attempts',
        billingRetryAttempts: 'Billing retry attempts',
        downloadMaxBytes: 'Reference image max bytes',
        downloadMaxPixels: 'Reference image max pixels',
        maxReferenceImages: 'Reference images per task',
        maxReferenceTotalBytes: 'Reference image aggregate bytes',
        maxReferenceTotalPixels: 'Reference image aggregate pixels',
        downloadTimeoutSeconds: 'Reference download timeout (seconds)',
        referenceFetchConcurrency: 'Reference download concurrency',
        referenceCacheTTLSeconds: 'Reference cache TTL (seconds)',
        referenceCacheMaxBytes: 'Reference cache capacity (bytes)',
        uploadTimeoutSeconds: 'SC upload timeout (seconds)',
        downloadMaxRedirects: 'Reference download max redirects',
		geminiHalfKModels: 'Gemini models allowed to use 0.5K',
    ...
    users: {
      ...
      group: 'Group',
      none: 'None',
      geminiImageGroup: 'Gemini image group',
      openaiImageGroup: 'OpenAI image group',
      imagePlatformGroupsUpdated: 'Image platform groups updated',
      imagePlatformGroupsUpdateFailed: 'Failed to update image platform groups',
    ...
    groups: {
      ...
      imagePricing: {
        ...
        allowAsyncImageGeneration: 'Enable downstream async image API',
        asyncImageGenerationHint: 'Requests submitted through the new async endpoints use this group\'s existing upstream routing and image billing rules.',
        ...
        accountPoolsTitle: 'Image account pool routing',
        accountPoolsHint:
          'Choose one image routing dimension. All three configurations are saved independently, so switching modes keeps inactive pools. Use 101, 102:1, 103:1; equal priorities retain live-load balancing.',
        poolModeLegend: 'Image account pool routing mode',
        poolMode: {
          resolution: 'By resolution',
          model: 'By image model',
          model_resolution: 'Model + resolution'
        },
        modelPlaceholder: 'Search candidates or enter an exact model ID',
        addModel: 'Add model',
        removeModel: 'Remove model {model}',
        modelAccounts: 'Scheduled accounts',
        noModelsConfigured: 'No models added. Unconfigured requests use the group default account pool.',
        modelInvalidOrDuplicate: 'The model ID is invalid, duplicated, or contains an unsupported wildcard.',
        poolLoadFailed: 'Image account pools could not be loaded. This save will not overwrite the existing pools.',
        poolFallbackHint: 'A missing pool falls back to the group default account pool. If a configured pool has no schedulable accounts, the request fails without crossing pools. Client model IDs are matched exactly and case-sensitively.',
        pool1k: '1K accounts',
        pool2k: '2K accounts',
        pool4k: '4K accounts',
