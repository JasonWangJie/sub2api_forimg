export default {
    settings: {
      ...
      seo: {
        ...
        indexingDescription: 'When enabled, only the site root can be indexed. Sign-in, admin, payment, and all other pages remain excluded.',
        indexingOn: 'Homepage indexable',
        indexingOff: 'Site-wide noindex',
        siteURL: 'Primary site URL',
        siteURLPlaceholder: 'https://example.com/',
        siteURLHint: 'Used for canonical, Open Graph, structured data, and the sitemap. Enter an HTTP(S) root URL without a path, query, or fragment.',
        siteURLMissing: 'No primary URL is configured. Canonical, structured data, and the sitemap will not be emitted yet.',
        siteURLInvalid: 'Enter a valid HTTP(S) site root, such as https://example.com/.',
        httpsWarning: 'HTTPS is strongly recommended in production for security and search engine trust.',
        robotsOpen: 'Allows the homepage and blocks API paths',
        robotsClosed: 'Blocks all search engine crawling',
        openRobots: 'Open robots.txt',
        sitemapReady: 'Available after saving',
        sitemapUnavailable: 'Requires indexing and a primary URL',
        openSitemap: 'Open sitemap.xml',
        metadataTitle: 'Homepage metadata',
        metadataDescription: 'These values are written into the first HTML response so Google and Bing can read them without waiting for JavaScript.',
        title: 'SEO title',
        titleHint: 'Recommended length: 10–60 characters. When blank, the fallback is “Site Name - AI API Gateway”.',
        description: 'SEO description',
        descriptionHint: 'Recommended length: 50–160 characters. When blank, the site subtitle is used.',
        keywords: 'Keywords',
        keywordsPlaceholder: 'Type and press Enter',
        keywordsHint: 'Up to 20. Paste comma, semicolon, or newline-separated values. This is a compatibility field; Google generally ignores meta keywords.',
        ...
        discoveryTitle: 'Social image and site verification',
        discoveryDescription: 'Configure social sharing cards and connect Google Search Console, Bing Webmaster Tools, and similar services.',
        socialImage: 'Social image URL',
        socialImagePlaceholder: 'https://example.com/social-card.jpg',
        socialImageHint: 'Optional. Use a publicly accessible HTTPS image at 1200×630. This enables Open Graph and Twitter large-image cards.',
        imageHTTPSWarning: 'Use HTTPS so search engines and social platforms can fetch the image securely.',
        verificationTags: 'Webmaster verification meta tags',
        verificationPlaceholder: '<meta name="google-site-verification" content="verification-token" />',
        verificationHint: 'Paste one meta tag with name and content per line. Scripts, event handlers, http-equiv, extra attributes, and system-managed SEO names are rejected and valid tags are normalized on save.',
        previewTitle: 'Search result preview',
        previewDescription: 'A live approximation of the homepage URL, title, and description from the current form.',
      ...
      defaults: {
        ...
        billingChargeMultiplierSelectedGroups: 'Selected groups',
        billingChargeMultiplierNoGroups: 'No groups are selected, so the system charge multiplier will not apply to any requests.',
      ...
      imageConcurrency: {
        title: 'Image Concurrency Gate',
        description: 'Limits image-generation requests executing in this process. OpenAI and Gemini, synchronous and asynchronous requests share the same slots.',
        source: 'Current source',
        sourceSystem: 'System settings',
        sourceYaml: 'config.yaml',
        hotReloadHint: 'New image requests use saved values immediately without a restart. Active requests are not interrupted.',
        multiInstanceHint: 'Each instance has its own limit. Total concurrency is approximately instance count multiplied by this limit.',
        enabled: 'Enable process-level image concurrency limit',
        enabledHint: 'When disabled, this layer does not limit requests. Text-model requests never consume these slots.',
        maxConcurrentRequests: 'Concurrent request limit',
        maxConcurrentRequestsHint: '0 means unlimited.',
        overflowMode: 'Behavior at capacity',
        overflowWait: 'Wait in memory queue',
        overflowReject: 'Return HTTP 429 immediately',
        waitTimeoutSeconds: 'Maximum wait (seconds)',
        waitTimeoutSecondsHint: 'Only used in wait mode. 0 means do not wait.',
        maxWaitingRequests: 'Waiting queue limit',
        maxWaitingRequestsHint: 'Only used in wait mode. 0 means unlimited waiters.',
        fallbackTitle: 'config.yaml fallback',
        fallbackSummary: 'Enabled: {enabled}, concurrency: {concurrency}, mode: {mode}, wait: {timeout}s, queue: {waiting}',
        yes: 'yes',
        no: 'no',
        save: 'Save and apply now',
        reset: 'Restore config.yaml',
        resetConfirm: 'Delete the system-settings override and restore image concurrency values from config.yaml?',
        loadFailed: 'Failed to load image concurrency settings',
        saveSuccess: 'Image concurrency settings saved and applied',
        saveFailed: 'Failed to save image concurrency settings',
        resetSuccess: 'Restored image concurrency settings from config.yaml',
        resetFailed: 'Failed to restore config.yaml settings',
        invalidNonNegativeInteger: 'Concurrency, wait time, and queue limit must be non-negative integers'
      },
      gatewayForwarding: {
