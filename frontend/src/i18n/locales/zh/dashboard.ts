export default {
  ...
  keys: {
    ...
    groupLabel: '分组',
    selectGroup: '选择分组',
    geminiImageGroupLabel: 'Gemini 生图分组',
    openaiImageGroupLabel: 'OpenAI 生图分组',
    selectImageGroupOptional: '可选，用于异步生图双平台',
    imagePlatformGroupsHint: '同一把 Key 可分别绑定 Gemini / OpenAI 异步生图计费组；不填则回退到主分组。',
    statusLabel: '状态',
    selectStatus: '选择状态',
    saving: '保存中...',
    noKeysYet: '暂无 API 密钥',
