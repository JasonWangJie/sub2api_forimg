export default {
  asyncImageTasks: {
    ...
    detail: {
      ...
      group: '分组',
      account: '最终账号',
      accountAudit: '账号尝试与对账',
      accountAttemptCount: '尝试账号数',
      reconciliationStatus: '对账状态',
      lastFailureReason: '最后失败原因',
      accountAttemptHistory: '查看尝试历史（{count} 次）',
      attemptedAt: '尝试时间',
      attemptStatus: '尝试状态',
      httpStatus: 'HTTP 状态码',
    ...
    terminate: {
      ...
      success: '任务已手动结束为失败',
      currentPageAction: '结束当前页（{count}）',
      currentPageTitle: '批量结束当前页任务',
      currentPageMessage: '确定将当前页的 {count} 个可结束任务标记为失败吗？不会重试生图，且无法撤销。',
      currentPageConfirm: '结束 {count} 个任务',
      currentPageResult: '已结束 {terminated} 个，跳过 {skipped} 个，失败 {failed} 个',
    },
    errors: {
      load: '加载异步生图任务失败',
      detail: '加载任务详情失败',
