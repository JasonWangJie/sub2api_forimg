...
```dotenv
APPLE_CONTAINER_SUB2API_IMAGE=ghcr.io/jasonwangjie/sub2api_forimg:latest
...
SUB2API_IMAGE=ghcr.io/jasonwangjie/sub2api_forimg:latest # Match APPLE_CONTAINER_SUB2API_IMAGE in .env.
