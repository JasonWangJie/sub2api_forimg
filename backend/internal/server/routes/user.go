	...
	authenticated.Use(gin.HandlerFunc(auditLog))
	{
		...
		if h.ImageLibrary != nil {
			library := authenticated.Group("/user/image-library")
			{
				...
				library.GET("/submission-requests", h.ImageLibrary.ListMySubmissionRequests)
				library.POST("/submission-requests", h.ImageLibrary.CreateSubmissionRequest)
				library.POST("/submission-requests/:request_id/sync", h.ImageLibrary.SyncSubmissionRequest)
				library.DELETE("/submission-requests/:request_id", h.ImageLibrary.WithdrawSubmissionRequest)
