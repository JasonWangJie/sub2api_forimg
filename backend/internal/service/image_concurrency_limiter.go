...
// ImageConcurrencyLimiter bounds image-generation requests across every
// protocol handler in this process. A single instance is owned by the shared
// ConcurrencyService so OpenAI and Gemini cannot each consume the full limit.
